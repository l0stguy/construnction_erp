...
if($_POST) {	
  ...
  $gstn 				= $_POST['gstn'];
	...
	$sql = "UPDATE orders SET orderDate = '$orderDate',clientName = '$clientName', 	clientContact = '$clientContact', subTotal = '$subTotalValue', totalAmount = '$totalAmountValue', discount = '$discount', grandTotalValue = '$grandTotalValue', paid = '$paid', paymentType = '$paymentType',paymentStatus = '$paymentStatus',id = '$userid',paymentPlace = '$paymentPlace' , gstn = '$gstn' WHERE id = {$orderId}";
	//echo $sql;exit;	
	$connect->query($sql);
